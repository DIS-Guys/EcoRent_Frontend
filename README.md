...
- If `VITE_API_URL` is not set, the app falls back to `http://localhost:3000`
...
4. Run ```npm run dev``` to launch front-end part
5. Visit http://localhost:5173/ to see the site ;)
6. Use ```npx playwright test  --reporter=html``` to run e2e tests (you need to have backend running)
