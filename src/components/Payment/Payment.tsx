        ...
        <div className="cards-block">
            ...
            <div className="card-info-block">
              <div className="left-block">
                ...
                <div className="owner-name-block">
                  <p className="card-info-text big-input-label owner-label">
                    Ім'я власника
                  </p>
                  <input
                    className="big-input"
                    placeholder="Stanislav Yukhymenko"
                  />
                </div>
              </div>
              <div className="right-block">
                <div className="expiration-date-block">
                  ...
                  <input
                    className="small-input expiration-date"
                    placeholder="09/26"
                  />
                </div>
              </div>
          ...
          <div className="red-card">
            ...
            <div className="cvv-block">
              ...
              <input
                className="small-input cvv-input"
                type="text"
                placeholder="328"
              />
            </div>
